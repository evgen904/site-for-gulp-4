...
!function (e, t, n, o, r) {
    ...
    "use strict";
    var an = "fullpage-wrapper", sn = "." + an, cn = "fp-responsive", un = "fp-notransition", fn = "fp-destroyed",
        dn = "fp-enabled", vn = "fp-viewing", pn = "active", hn = "." + pn, gn = "fp-completely", mn = "fp-section",
        Sn = "." + mn, bn = Sn + hn, wn = "fp-tableCell", yn = "." + wn, En = "fp-auto-height", xn = "fp-normal-scroll",
        An = "fp-nav", Ln = "#" + An, Mn = "fp-tooltip", Tn = "fp-slide", On = "." + Tn, kn = On + hn, Cn = "fp-slides",
        Hn = "." + Cn, Rn = "fp-slidesContainer", In = "." + Rn, zn = "fp-table", Bn = "fp-slidesNav", Nn = "." + Bn,
        jn = Nn + " a", e = "fp-controlArrow", Pn = "." + e, Wn = "fp-prev", Dn = Pn + ".fp-prev", Yn = Pn + ".fp-next";
    ...
    return rn.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function (e, t) {
        ...
        if (!Gn(s, dn)) {
            ...
            var G, F, U, Q = !1, _ = 0, J = 0, K = 0, $ = 0, q = (new Date).getTime(), ee = 0, te = 0, ne = y;
            return S
        }
        ...
        function Ce() {
            ...
            if (So(w, "onScroll"), (!g.autoScrolling || g.scrollBar || Ut("dragAndMove")) && !Jt()) {
                var t = Ut("dragAndMove") ? Math.abs(S.dragAndMove.getCurrentScroll()) : po(), n = 0, o = t + Fn() / 2,
                ...
                if (!Gn(e = i[n], pn)) {
                    Q = !0;
                    var a, s, c = Zn(bn)[0], u = eo(c, Sn) + 1, f = Ot(e), d = e.getAttribute("data-anchor"),
                        v = eo(e, Sn) + 1, p = Zn(kn, e)[0], h = {
                            activeSection: c,
                            sectionIndex: v - 1,
                            anchorLink: d,
                            element: e,
        ...
        function Re(e) {
            if (v.m[e]) {
                ...
                if (Ut("scrollHorizontally") && (t = S.scrollHorizontally.getScrollSection(e, t)), g.scrollOverflow) {
                    var n = g.scrollOverflowHandler.scrollable(Zn(bn)[0]), o = "down" === e ? "bottom" : "top";
                    if (null != n) {
        ...
        function Pe(e) {
            ...
            if (g.autoScrolling && !c && !n) {
                var o = (e = e || rn.event).wheelDelta || -e.deltaY || -e.detail, r = Math.max(-1, Math.min(1, o)),
        ...
        function ct() {
            if (!Q && !g.lockAnchors) {
                var e = ut(), t = e.section, n = e.slide, o = void 0 === b, r = void 0 === b && void 0 === n && !a;
                if (t && t.length) {
